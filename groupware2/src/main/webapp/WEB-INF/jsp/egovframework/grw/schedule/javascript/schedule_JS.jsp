		...
		var scheupd = function(_obj){
			...
			swalInit.fire({
				...
				if (result.value) {
					...
					var formData = new FormData($("#scheUpdFrm")[0]);
					
					$.ajax({
			            type : "post",
			            url : "/grw/schedule/scheduleUpd.do",
				        dataType : "json",
				        contentType: false,
				        processData: false,
				        data : formData,
			            ...
			            success : function(_data){
			            	if(_data.result == "success"){
			            		//alert("success");
				            	document.location = "/grw/schedule/scheduleSel.do?scheId="+$("#scheUpdFrm").find("input[name=scheId]").val();
			            	}else{
			            		swalInit.fire("오류 발생","서버 요청 도중 오류가 발생했습니다!!!","error");
			            	}
			            }
