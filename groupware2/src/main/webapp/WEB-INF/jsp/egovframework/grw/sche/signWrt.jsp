...
<div class="card border-grey-300 my-0 mb-1">
	...
	<div class="card-body px-2 py-2">
		...
		<form id="frmWrt" name="frmWrt" method="post" >
			...
			<div class="form-group mb-2">
				<label class="form-label-sm mb-0">결재 유형</label><strong class="text-danger pl-1">*</strong> 
			...
			<div class="form-group mb-2">
				<label class="form-label-sm mb-0">중간 승인자 선택</label><strong class="text-danger pl-1">*</strong> 
				...
				<label class="form-label-sm mb-0">최종 승인자 선택</label><strong class="text-danger pl-1">*</strong> 
