...
<script type="text/javascript">
	...
	$(document).ready(function(){
		...
		******************************************/
		...
		(function(){
			var contentId = "${contUpd.contentId}";
			console.log(contentId);
			$.getJSON("/board/fileLst", {contentId:contentId}, function(arr){
				console.log(arr);
				var str = "";
				...
				$(arr).each(function(i, attach){
					...
					// image type
					if (attach.fileType) {
						var fileCallPath = encodeURIComponent("/" + attach.origFileName);
						str += "<li style='cursor:pointer' data-origFileName='"+attach.origFileName+"'data-type='"+attach.fileType+"'>";
						str += "<span> " + attach.origFileName + " </span>";
